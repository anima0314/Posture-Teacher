...
public class Measure2DatasEntity {
    ...
    public Measure2DatasEntity(int DB_Measure2DataID, LocalDateTime DB_Measure2DataStartTime, LocalDateTime DB_Measure2DataEndTime, LocalDateTime DB_Measure2RoundStartTimeFK) {
